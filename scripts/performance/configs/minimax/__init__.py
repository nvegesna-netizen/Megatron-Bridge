...
if HAVE_MEGATRON_BRIDGE:
    from .minimax_m2_llm_pretrain import (
        minimax_m2_229b_a10b_pretrain_config_b200,
        minimax_m2_229b_a10b_pretrain_config_b300,
        minimax_m2_229b_a10b_pretrain_config_gb200,
        minimax_m2_229b_a10b_pretrain_config_gb300,
        minimax_m2_229b_a10b_pretrain_config_h100,
    )

from .minimax_workload_base_configs import (
