...
# VR200 V2: alias GB300 V2 to stay consistent with new-main's VR200->GB300 choice (#4574).
# (The glm branch aliased GB200 V2; re-homed to GB300 V2 since VR200 V1 now aliases GB300.)
# VR200 has 4 GPUs/node vs 8 for GB300; adjust num_nodes in the JET-LLM YAML accordingly.
# No VR200_FP8_CS_V2 — consistent with V1 which also has no VR200_FP8_CS entry.
KIMI_K2_PRETRAIN_CONFIG_VR200_BF16_V2 = KIMI_K2_PRETRAIN_CONFIG_GB300_BF16_V2
KIMI_K2_PRETRAIN_CONFIG_VR200_FP8_MX_V2 = KIMI_K2_PRETRAIN_CONFIG_GB300_FP8_MX_V2
...
# cuda_graph_scope; the pending qk_clip fix (kimi_llm_pretrain.py) confirms an
